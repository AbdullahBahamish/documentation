...
.. example::
   ...
   :guilabel:`Role` column. Repeat that process for all five rooms.
...
In the new product window, select the :guilabel:`Sales` checkbox. Select the :guilabel:`Product
Type` as :guilabel:`Service`. In the :guilabel:`Invoicing Policy` drop-down menu, select
...
.. example::
   ...
   two adults or two adults and a child. The hotel also offers breakfast and internet.
