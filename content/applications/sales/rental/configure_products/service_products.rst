...
.. example::
   **Part 1**
   ...
   Enter the :guilabel:`Sales Price` and then click the :guilabel:`Sales` tab and set the
   :guilabel:`Periodicity` to :guilabel:`Hours` and enter `24` for the :guilabel:`Padding Time`.
   ...
   and click :guilabel:`New`. Configure Pricelist Rules for the daily rate with the following
   settings:
