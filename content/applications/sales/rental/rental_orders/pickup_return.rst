...
=================================
Pickup and return rental products
=================================
...
policy requires a signed rental contract, :ref:`request the customer's signature
<rental/create_rental_order/customer-signature>` before the rental product is picked up.

.. seealso::

   :doc:`../configure_products/product_type`
...
Refer to the physical rental products :ref:`settings <rental/products/default-settings>` to see the
apps required. If :ref:`product tracking <rental/products/configure-product-tracking>` is enabled,
the pick up and return process requires additional steps.
...
**Planning**, and **Sales** apps to be installed. For physical service products, configure the
:ref:`materials and roles <rental/service_products/materials-and-roles>` in the **Planning** app
...
If the business wants to sell service rental products on an online shop, refer to the
:ref:`Configure pickup and return availability for eCommerce products
<rental/pickup_return/ecommerce-products>` section.
...
The Rental app supports :ref:`eCommerce configuration at a app
<rental/product_type/ecommerce-settings>` and product level when the **Website** app and the
**eCommerce** module are installed. Using the *Unavailability days* setting restricts the days the
rental website allows pickup and returns to be scheduled. To configure the rental product page in
the online store, refer to the :ref:`Product configuration
<ecommerce/products/product-configuration>` section for the eCommerce module.

.. _rental/pickup_return/pickup:

Pickup a rental product
=======================
...
Pickup a physical rental product with tracking enabled
------------------------------------------------------
...
Pickup a rental product and a rental service
--------------------------------------------
