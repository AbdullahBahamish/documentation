...
This information can assist the recruiting team to see where the various rates are in terms of their
hiring goals, and pivot their strategies to acquire more desirable candidates.
...
Hover the cursor over a month of the chart and an *Applicant* pop-up window appears, displaying the
specific numbers for that month.
...
.. tip::
   ...
   applications that are :guilabel:`In Progress`, :guilabel:`Hired`, :guilabel:`Refused`, along with
   the totals for all three in the :guilabel:`Applications` column. These numbers are organized by
   month, then job position.

   In this example, out of the fourteen new hired employees, the :guilabel:`Furniture Assembler` job
   position had the most new hires, with a total of six new employees.
